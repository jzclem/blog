<template>
  <div>
    <section :style="'background-image: linear-gradient(120deg, '+backgroundColorLeft+', '+backgroundColorRight+');color: '+fontColor+';'"
             class="page-header">
      ...
      <div v-for="(item,index) in randomIcon"
           :key="'ri'+index"
      ...
      <a v-if="!mini" class="btn" href="https://github.com/jzclem/blog" target="_blank">博客源码</a>
    </section>
    <div style="position:relative;  z-index:2;margin: auto;margin-top:-30px;width:64rem;display: none">
      <el-card :body-style="{ padding: '0px' }" shadow="never">
        <el-row>
          <el-col :span="10">
            <el-menu :default-active="topbar.active"
                     menu-trigger="click"
                     mode="horizontal"
          ...
          <el-col :span="8" style="text-align: center;padding: 12px 0 0 10px">
            <el-row>
              <el-col :span="4">
              ...
              <el-col :span="14" style="padding-left: 20px">
                <el-slider v-model="music.currentTime"
          ...
          <el-col :span="4" style="text-align: right;">
            ...
            <div style="color:#606266;">
              <i class="el-icon-location"></i>&nbsp;{{ location ? location : '未填写地址' }} <br>
            </div>
          </el-col>
          <el-col :span="2" style="text-align: center;">
            <img v-popover:bigAvatar
                 :src="avatarUrl"
            ...
            <el-popover ref="bigAvatar" :title="githubUsername" placement="top-start" trigger="hover" width="200">
              <i class="el-icon-star-on"></i>&emsp;{{ name }} <br> <i class="el-icon-location"></i>&emsp;{{ location }}
              <br> <img :src="avatarUrl" style="width: 200px;height: 200px;">
            </el-popover>
          </el-col>
        </el-row>
      </el-card>
