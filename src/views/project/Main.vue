<template>
  <div v-loading="loading" style="min-height: 600px">
    ...
    <div v-if="projects&&projects.length>0">
      <el-card v-for="(item,index) in projects"
               v-if="!item.hide"
               :key="'pro'+index"
               shadow="hover"
          ...
          <el-row>
            ...
            <el-col :span="8">
              <div style="text-align: right;">
                <el-button icon="el-icon-back" style="padding: 3px 0" type="text" @click="goGithub(item.url)">前往GitHub
                </el-button>
                <el-button icon="el-icon-share"
                           style="padding: 3px 0"
                           type="text"
                           @click="$share('/user/project/details/'+item.name)"></el-button>
              </div>
            </el-col>
          </el-row>
        </div>
    ...
    <el-card v-if="!projects||projects.length==0"
             shadow="never"
