<template>
  <div v-loading="loading" style="min-height: 800px">
    <el-card shadow="never" style="min-height: 400px;margin-bottom: 20px;">
      <el-form ref="configureForm" :model="configure" :rules="rules" label-width="100px">
              ...
              <el-row>
                <el-col :span="3">
                  <el-form-item label="背景颜色">
                    <el-color-picker v-model="configure.backgroundColorLeft"
                                     :predefine="predefineColors"></el-color-picker>
                  </el-form-item>
                </el-col>
                <el-col :span="21">
                  <el-form-item>
                    <el-color-picker v-model="configure.backgroundColorRight"
                                     :predefine="predefineColors"></el-color-picker>
                  </el-form-item>
                </el-col>
              </el-row>
              ...
              <el-row v-for="(item,index) in configure.webSites" :key="'webSites'+index" style="margin-bottom: 10px">
                ...
                <el-col :span="2">
                  <el-button circle
                             ...
                             style="float: right;"
                             type="danger"
                             @click="removeWebSites(index)"></el-button>
                </el-col>
              </el-row>
              <el-button circle
                         icon="el-icon-plus"
                         style="float: right;"
                         type="success"
                         @click="addWebSites"></el-button>
            </el-form-item>
          </el-tab-pane>
        </el-tabs>
        <el-form-item>
          <el-button :disabled="submitButton.disabled" :loading="submitButton.loading" type="primary" @click="submit">
            修改配置
          </el-button>
          <el-button @click="reset">还原</el-button>
          <el-popover content="打开极简模式将隐藏部分不主要的菜单, 音乐链接需要是媒体 (不可以是HTML页面)"
                      placement="top-end"
                      trigger="click"
                      width="200">
            <el-button slot="reference" icon="el-icon-question" style="float: right;" type="text">说明</el-button>
          </el-popover>
        </el-form-item>
      </el-form>
    </el-card>
