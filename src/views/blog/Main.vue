<template>
  <div v-loading="loading" style="min-height: 600px">
    <el-card shadow="never" style="margin-bottom: 20px">
      ...
      <el-button circle icon="el-icon-share" plain style="margin-left: 10px" type="warning"
    ...
    <div v-if="blogs&&blogs.length>0">
      <el-card v-for="(item,index) in blogs" v-if="!item.hide" :key="'p'+index" shadow="hover"
          ...
          <el-row>
            ...
            <el-col :span="8">
              <div style="text-align: right;">
                <el-button icon="el-icon-share" style="padding: 3px 0" type="text"
                           @click="$share('/user/blog/details/'+item.id)"></el-button>
                <el-button v-if="token" icon="el-icon-edit" style="padding: 3px 0" type="text"
                           @click="editBlog(index)"></el-button>
                <el-button v-if="token" icon="el-icon-delete" style="padding: 3px 0" type="text"
                           @click="deleteBlog(index)"></el-button>
              </div>
            </el-col>
          </el-row>
        </div>
    ...
    <el-card v-if="!blogs||blogs.length==0" shadow="never"
