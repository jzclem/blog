<template>
    ...
    <div :style="'background: #f8f8f8;min-height: '+windowSize.height+'px'">
        ...
        <van-cell class="mobile-border mobile-margin-top" title="　github.com/jzclem" icon="sign" url="https://github.com/jzclem"
            is-link />

        <van-cell class="mobile-border mobile-margin-top" title="　项目源码" icon="logistics" url="https://github.com/jzclem/Blog"
            is-link />
